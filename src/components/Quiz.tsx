      ...
      <div className="w-full max-w-3xl flex flex-col">
        ...
        <div className="bg-gradient-to-r from-blue-900 to-blue-700 rounded-t-3xl p-6 sm:p-8 text-white shadow-lg">
          <div className="flex justify-between items-end mb-4">
            <span className="text-sm sm:text-base font-medium opacity-80">Évaluation en cours</span>
        ...
        <div className="bg-white rounded-b-3xl shadow-xl p-6 sm:p-8 md:p-10 flex flex-col">
          <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-slate-800 mb-8 leading-snug">
            {question.question}
          </h2>
          ...
          <div className="space-y-4 flex-1">
            {question.answers.map((answer, index) => {
              ...
              let containerClass = "flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-6 p-4 sm:p-5 rounded-2xl border-2 transition-all duration-300 w-full text-left ";
              ...
              return (
                ...
                >
                  ...
                  <span className="text-base sm:text-lg text-slate-700 font-medium leading-relaxed flex-1 pt-1 sm:pt-0">
                    {answer.text}
                  </span>
                </button>
              );
